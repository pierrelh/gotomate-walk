...
// PixelColor Define the GetPixelColor databinder
...
// MouseColor Define the GetMouseColor databinder
type MouseColor struct {
	Var   string
	Value string
}

// ScreenSize Define the GetScreenSize databinder
...
// SaveCapture Define the SaveCapture databinder
